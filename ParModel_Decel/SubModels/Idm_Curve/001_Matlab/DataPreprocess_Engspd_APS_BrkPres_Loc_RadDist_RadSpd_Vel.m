...
%         if Dataset{1,i}.ACC_ObjDist(j,1) > 130
%             Dataset{1,i}.ACC_ObjDist(j,1) = 0;
%         end
%     end
%     
% end
...
for i = 1 : Numdataset
    ...
    AugRadDis = cat(1,AugRadDis,Dataset{1,i}.ACC_ObjDist(1:EndArr(i),1));
    AugRadSpd = cat(1,AugRadSpd,Dataset{1,i}.ACC_ObjRelSpd(1:EndArr(i),1));
end
...
Resized_AugRadDis=ResizeData(AugRadDis,Resize);
Resized_AugRadSpd=ResizeData(AugRadSpd,Resize);
...
for i = 1 : Numdataset
    ...
    %RadarDistance
    RadarDistance = Dataset{1,i}.ACC_ObjDist(1:EndArr(i),1);
    ...
    RadarRelativeSpeed = Dataset{1,i}.ACC_ObjRelSpd(1:EndArr(i),1);
...
ExperimentDataset_Augmented(:,5) = Resized_AugRadDis;
ExperimentDataset_Augmented(:,6) = Resized_AugRadSpd;
ExperimentDataset_Augmented(:,7) = Resized_AugVel;
%%
...
csvwrite('F:\001_Project\003_Cx\005_SpeedPrediction\001_Keras\Experiment_Augmented_EngSpd_APS_BrkPres_Loc_RadDist_RadSpd_Vel_Sel.csv',ExperimentDataset_Augmented);
