...
Dataset = load('../006_Midan/Curvature_MidanA/Logging_M02_1axis.mat'); % Vehicle driving data
%% 1. Data Preprocess
%%    1.1 Vehicle Data
...
subplot(3,1,3)
plot(pltIndxRoad,sn_SteeringAg,'black','linewidth',2);
hold on;
plot(pltIndxRoad,HC_sn_SteeringAngle,'g*','linewidth',4);
hold off;
